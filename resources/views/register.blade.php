                    ...
                    <div class="col-xxl-5 col-md-6 col-sm-8">
                        <div class="card p-4">
                            <div class="auth-brand text-center mb-2">
                                ...
                                <p class="text-muted w-lg-75 mx-auto">Let’s get you signed up.</p>
                            </div>
                            ...
                            <p class="text-muted text-center mt-4 mb-0">
                                Have an account?
                                <a href="{{ url('/get-started') }}" class="text-decoration-underline link-offset-3 fw-semibold">Sign in</a>
                            </p>
                        </div>
