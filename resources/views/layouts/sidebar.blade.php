        ...
        <div id="sidenav-menu">
            <ul class="side-nav">
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#tasks" aria-expanded="false" aria-controls="tasks" class="side-nav-link">
                        <span class="menu-icon"><i class="fa fa-list-check"></i></span>
                        <span class="menu-text" data-lang="tasks">Purchases</span>
                        <span class="menu-arrow"></span>
                    </a>
                    <div class="collapse" id="tasks">
                        <ul class="sub-menu">
                            <li class="side-nav-item">
                                <a href="apps-task-list.html" class="side-nav-link">
                                    <span class="menu-text" data-lang="apps-task-list">List</span>
                                </a>
                            </li>
                            <!-- <li class="side-nav-item">
                                <a href="apps-task-details.html" class="side-nav-link">
                 ...
                 <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#tasks" aria-expanded="false" aria-controls="tasks" class="side-nav-link">
                        <span class="menu-icon"><i class="fa fa-list-check"></i></span>
                        <span class="menu-text" data-lang="tasks">Leave</span>
                        <span class="menu-arrow"></span>
                    </a>
                    <div class="collapse" id="tasks">
                        <ul class="sub-menu">
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#pages" aria-expanded="false" aria-controls="pages" class="side-nav-link">
                        ...
                        <span class="menu-text" data-lang="pages"> Manage Users</span>
                        <span class="menu-arrow"></span>
                    </a>
