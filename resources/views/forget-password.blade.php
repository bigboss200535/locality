...
<html lang="en">
    ...
    <body>
        <div class="position-absolute top-0 end-0">
            <img src="{{ asset('images/auth-card-bg.svg') }}" class="auth-card-bg-img" alt="auth-card-bg" />
        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xxl-5 col-md-6 col-sm-8">
                        <div class="card p-4">
                            ...
                            <!-- <p class="text-center text-muted my-3 auth-line">
                               ...
                               <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-primary fw-semibold py-2">Forget Password</button>
                                </div>
                            </form>

                            <p class="text-muted text-center mt-4 mb-0">
                                New here?
                                <a href="{{ url('/create-account') }}" class="text-decoration-underline link-offset-3 fw-semibold">Create an account</a>
                            </p>
                        </div>
                        ...
                        <p class="text-center text-muted mt-4 mb-0">
                          ...
                          VetMe |
                            <span class="fw-semibold">WebEdge Technology</span>
                        </p>
                    </div>
                </div>
            </div>
